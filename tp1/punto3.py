...
def save_frec_infile():
    file_frecs = open("frecuencias_stemming.txt", "x",encoding='utf-8')
...
def main():
    ...
    file_terms = open("terminos_stemming.txt", "x",encoding='utf-8')
    ...
    file_stats = open("estadisticas_stemming.txt", "x",encoding='utf-8')
